...
export function sidebar(){
    ...
    sidebarInner.innerHTML = `
            ...
            <div class="sidebar-footer">
                <p class="copyright">
                    Copyright 2023 <i class="fa-regular fa-copyright fa-xs"></i>
                </p>

                <img src="assets/images/logo.png" width="130" height="18" alt="Logo-Netflix">
            </div>
    `;
    ...
    const toggleSidebar = function(sidebar){
        // Toggle sidebar in mouse click or small screen
