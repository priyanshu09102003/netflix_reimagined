...
//Fetching the genre of the clicked movie
...
//Fetching the cast of the clicked movie
...
//Fetching the director of the clicked movie
...
//Fetching the videos of trailers and teasers
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases` , function(movie){
    ...
    document.title = `${title} `; //Changing the title on click
            ...
            <div class="detail-box">
                ...
                <div class="detail-content">
                    ...
                    <div class="meta-list">
                        ...
                        <div class="meat-item card-badge">${certification}</div>
    ...
    // Fetching data of Recommended movies from server
